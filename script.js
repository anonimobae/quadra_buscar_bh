...
// Função para atualizar o dropdown de bairros com base na região selecionada
function atualizarBairros() {
    const regiao = document.getElementById('regiao').value;
    const bairroSelect = document.getElementById('bairro');

    // Reseta o dropdown de bairros
    bairroSelect.innerHTML = '<option value="">Todos os bairros da região</option>';

    // Adiciona os bairros únicos da região selecionada
...
// Função para buscar e exibir os dados filtrados
function buscarQuadras() {
    ...
    resultados.forEach(q => {
        ...
        div.innerHTML = `
            <strong>Local: ${q.local}</strong><br>
            Região: ${q.regiao}<br>
            Bairro: ${q.bairro}<br>
...
// Configura os eventos para os dropdowns e botão de busca
